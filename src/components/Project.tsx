...
const Project: React.FC<Props> = ({ imgsrc, title, skillsHighlight, skills, link, children }) => {
  ...
  return (
    <div className='project-item flex flex-col sm:flex-row gap-8 mb-8 p-4 max-w-[50rem] relative duration-200 ease-in-out border-b border-[#00000011]' onClick={handleOnClick}>
      ...
      <div className='detail flex-1'>
        <div className='text-md mb-3 font-[500]'>{title} <span className='arrow'></span></div>
        {children}
