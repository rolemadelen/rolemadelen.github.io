          ...
          <div
            ...
            <aside className='aside left main header mx-8 pt-4 lg:pt-8 lg:pb-20 flex flex-col justify-between'>
              <header>
                ...
                <h2
                  className='mb-12 text-md text-gray-500'
                  ref={roleRef}>
                  Front-End Engineer
                </h2>
              ...
              <nav className='nav text-sm border-b-[1px] border-[#ccc] lg:border-0 pb-20 lg:pb-10 text-gray-800'>
                <ul className='nav-list mb-8'>
                  ...
                  <li>
                    <a
                      className='nav-item'
                      href='https://www.bepersistent.dev/'
                      target='_blank'
                      rel='noopener noreferrer'>
                      Blog
                    </a>
            ...
            <div
              className='content lg:overflow-scroll h-auto pt-16 lg:py-8 mb-20'
