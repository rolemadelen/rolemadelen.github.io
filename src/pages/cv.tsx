        ...
        <ContentRight>
          <Experience className='experience'>
            ...
            <UList>
              ...
              <WorkDetail>
                - Initiated and played a key role in creating the coding
                guidelines for the team, promoting consistency and best
              ...
              <WorkDetail>
                - Successfully advocated for the adoption of Notion as the
                primary resource for onboarding, error reports, document
                management, planning, and internal wiki purposes, resulting in
                enhanced efficiency and collaboration within the team.
              </WorkDetail>
            </UList>
            <UList>
              ...
              <WorkDetail>
                - Utilized HTML/CSS, JavaScript, and PHP to develop a subpage
                that effectively introduced the company's product, utilizing a
                given template.
              </WorkDetail>
            </UList>
            <UList>
              ...
              <WorkDetail>
                - Provided programming support in C++ and Java, assisting
          ...
          <Experience className='experience'>
            ...
            <UList>
              ...
              <WorkDetail>
                - Taught English to diverse groups of students, ranging from
                third to sixth grade, at four different elementary schools in
                Japan.
              </WorkDetail>
              <WorkDetail>
                - Developed and implemented engaging lesson plans to facilitate
                language acquisition, focusing on listening, speaking, reading,
                and writing skills.
              </WorkDetail>
              <WorkDetail>
                - Adapted instructional materials and teaching strategies to
                meet the needs and learning styles of individual students.
              </WorkDetail>
              <WorkDetail>
                - Collaborated with fellow teachers and school staff to
                coordinate educational activities and promote a supportive
                learning environment.
              </WorkDetail>
            </UList>
            <UList>
              <Company>
                Riverside City College | Track & Field Team Manager
              </Company>
              <CompanyLoc>Riverside, CA | Sept 2015 - Apr 2016</CompanyLoc>
              <WorkDetail>
                - Assisted with inventory management, ensuring proper equipment
                availability for practices and meets.
              </WorkDetail>
              <WorkDetail>
                - Provided support to runners, coaches, and staff during
                training sessions and competitions.
              </WorkDetail>
              <WorkDetail>
                - Collaborated in setting up and organizing track meets,
                ensuring smooth operations and adherence to schedules.
              </WorkDetail>
            </UList>
          </Experience>
        </ContentRight>
